...
const StyleContentGuide = styled.div`
  display: flex;
  ...
  return (
    <StyleContentGuide>
      ...
      <div className="content">
        ...
        <div>
          Explain how you encountered the problem <br /> you’re trying to solve,
          and any difficulties that <br /> have prevented you from solving it
          yourself.
        </div>
      </div>
    </StyleContentGuide>
